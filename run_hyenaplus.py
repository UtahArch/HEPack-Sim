...
##  Running Hyena Packing with Smart Batching
##
##  Usage: python run_hyena.py <network> <ntttype> <arch> <poly_n> <batch>
##  Example: python run_hyena.py resnet f1 f1 1 1
#################################################################################
